(self["webpackChunkhsg_frontend"] = self["webpackChunkhsg_frontend"] || []).push([[256],{
  ...
  return _createClass(UsersSearchAndFilter, [{
    ...
    value: function updateUserList(users) {
      ...
      users.forEach(function (item) {
        ...
        row.innerHTML = "\n      ".concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("ID#", item.userId), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("avatar", (0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .avatarHtml */ .T5)("/images/users/".concat(item.avatar), item.firstName)), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("user_name", "".concat(item.firstName, " ").concat(item.lastName)), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("email", item.emailAddress), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("phone", item.phoneNumber), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("role", item.userRole), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("created_at", new Date(item.createdAt).toLocaleDateString()), "\n      ");
