(self["webpackChunkhsg_frontend"] = self["webpackChunkhsg_frontend"] || []).push([[642],{
  ...
  return _createClass(AdminTimetableSearchAndFilter, [{
    ...
    value: function updateTimetableList(timetables) {
      ...
      timetables.forEach(function (item) {
        var row = document.createElement("tr");
        row.innerHTML = "\n      ".concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("NO#", item.timetableNo), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("class", item.className), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("date", new Date(item.startDateTime).toLocaleString()), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("duration", item.duration), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("trainer", item.trainerFirstName), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("level", item.level), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("capacity", item.capacity), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("availability", item.availability), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("status", new Date(item.startDateTime) < Date.now() ? "finished" : "active"), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("edit", _this2.editButtonHtml(item.timetableId)), "\n      ");
