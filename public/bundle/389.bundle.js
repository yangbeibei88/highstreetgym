(self["webpackChunkhsg_frontend"] = self["webpackChunkhsg_frontend"] || []).push([[389],{
...
var TimetableSearchAndFilter = /*#__PURE__*/function () {
  ...
  return _createClass(TimetableSearchAndFilter, [{
    ...
    value: function bookingButtonTemplate(timetableId, avail) {
      ...
      return (0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("action", btnUI);
    }
  }, {
    ...
    value: function updateTimetableList(timetables) {
      ...
      timetables.forEach(function (item) {
        var row = document.createElement("tr");
        row.innerHTML = "\n      ".concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("date", new Date(item.startDateTime).toLocaleDateString("en-AU")), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("weekday", new Date(item.startDateTime).toLocaleDateString("en-AU", {
          weekday: "short"
        })), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("time", new Date(item.startDateTime).toLocaleTimeString("en-AU", {
          timeStyle: "short",
          hour12: false
