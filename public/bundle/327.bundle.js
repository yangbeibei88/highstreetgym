(self["webpackChunkhsg_frontend"] = self["webpackChunkhsg_frontend"] || []).push([[327],{
...
/* harmony export */ });
/* harmony import */ var _FnPagination_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(55);
/* harmony import */ var _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(580);
  ...
  return _createClass(AccbookingsSearchAndFilter, [{
    ...
    value: function updateBookingList(bookings) {
      ...
      bookings.forEach(function (item) {
        ...
        row.innerHTML = "\n      ".concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("No#", (0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .linkHtml */ .eq)(item.bookingNo, "/auth/account/booking-confirmation/".concat(item.bookingId))), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("member", "".concat(item.userFirstName, " ").concat(item.userLastName)), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("booking_date", new Date(item.createdAt).toLocaleString("en-AU", {
          hour12: false
        })), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("class_datetime", new Intl.DateTimeFormat("en-GB", {
          dateStyle: "full",
          timeStyle: "long",
          timeZone: "Australia/Brisbane"
        }).format(new Date(item.startDateTime))), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("class", item.className), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("duration", "".concat(item.duration, " mins")), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("level", item.level), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("trainer", item.trainerFirstName), "\n      ").concat((0,_HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_0__/* .rowHtml */ ._n)("status", item.status), "\n      ");
    ...
    value: function updatePagination(paginationData) {
      ...
      this.pagination = new _FnPagination_js__WEBPACK_IMPORTED_MODULE_1__/* .Pagination */ .d({
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   d: () => (/* binding */ Pagination)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   T5: () => (/* binding */ avatarHtml),
/* harmony export */   _n: () => (/* binding */ rowHtml),
/* harmony export */   eq: () => (/* binding */ linkHtml)
/* harmony export */ });
