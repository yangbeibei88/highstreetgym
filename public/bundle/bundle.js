  ...
  return _createClass(AccbookingsSearchAndFilter, [{
    ...
    value: function updateBookingList(bookings) {
      ...
      bookings.forEach(function (item) {
        ...
        row.innerHTML = "\n      ".concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("No#", new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().linkHtmlTemplate(item.bookingNo, "/auth/account/booking-confirmation/".concat(item.bookingId))), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("member", "".concat(item.userFirstName, " ").concat(item.userLastName)), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("booking_date", new Date(item.createdAt).toLocaleString("en-AU", {
          hour12: false
        })), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("class_datetime", new Intl.DateTimeFormat("en-GB", {
          dateStyle: "full",
          timeStyle: "long",
          timeZone: "Australia/Brisbane"
        }).format(new Date(item.startDateTime))), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("class", item.className), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("duration", "".concat(item.duration, " mins")), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("level", item.level), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("trainer", item.trainerFirstName), "\n      ").concat(new _HTMLTemplate_js__WEBPACK_IMPORTED_MODULE_1__.HTMLTemplate().rowHtmlTemplate("status", item.status), "\n      ");
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var HTMLTemplate = /*#__PURE__*/function () {
  function HTMLTemplate() {
    _classCallCheck(this, HTMLTemplate);
  }
  return _createClass(HTMLTemplate, [{
    key: "rowHtmlTemplate",
    value: function rowHtmlTemplate(field, value) {
    ...
    key: "linkHtmlTemplate",
    value: function linkHtmlTemplate(text, path) {
  ...
  return _createClass(TimetableSearchAndFilter, [{
    ...
    value: function updateTimetableList(timetables) {
      ...
      timetables.forEach(function (item) {
        ...
        var row = document.createElement("tr");
        row.innerHTML = "\n      ".concat(_this2.rowHtmlTemplate("date", startDateTime.toLocaleDateString("en-AU")), "\n      ").concat(_this2.rowHtmlTemplate("weekday", startDateTime.toLocaleDateString("en-AU", {
          weekday: "short"
        })), "\n      ").concat(_this2.rowHtmlTemplate("time", startDateTime.toLocaleTimeString("en-AU", {
          timeStyle: "short",
          hour12: false
        })), "\n      ").concat(_this2.rowHtmlTemplate("class", item.className), "\n      ").concat(_this2.rowHtmlTemplate("duration", item.duration), "\n      ").concat(_this2.rowHtmlTemplate("level", item.level), "\n      ").concat(_this2.rowHtmlTemplate("trainer", item.trainerFirstName), "\n      ").concat(_this2.rowHtmlTemplate("availability", item.availability), "\n      ").concat(_this2.bookingButtonTemplate(item.timetableId), "\n      ");
...
/* harmony import */ var _components_TimetableSearchAndFilter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/TimetableSearchAndFilter.js */ "./src/components/TimetableSearchAndFilter.js");
...
/* harmony import */ var _components_AccbookingsSearchAndFilter_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/AccbookingsSearchAndFilter.js */ "./src/components/AccbookingsSearchAndFilter.js");
...
document.addEventListener("DOMContentLoaded", function () {
  return new _components_MainNav_js__WEBPACK_IMPORTED_MODULE_8__.MainNav();
});
document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", function () {
  return new _components_TimetableSearchAndFilter_js__WEBPACK_IMPORTED_MODULE_6__.TimetableSearchAndFilter();
});
document.addEventListener("DOMContentLoaded", function () {
...
document.addEventListener("DOMContentLoaded", function () {
  return new _components_AccbookingsSearchAndFilter_js__WEBPACK_IMPORTED_MODULE_12__.AccbookingsSearchAndFilter();
});
})();
